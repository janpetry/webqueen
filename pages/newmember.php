...
<?php 
	if(isset($_POST['post1'])) {
		$firefighters->addYouthFirefighterMember($_POST['username'], $_POST['rang']);
	}
?>
<div class="page-header">
  <h1>Jugendmitglied hinzufügen</h1>
</div>
	<form method="post">
...
<?php
	...
	foreach($firefighters->getAllBadges() as $badge) {
		echo '<input type="checkbox" name="badge_check_'.$i.'" />
			  <img src="'.$badge['link'].'" alt="'.$badge['name'].'" data-toggle="tooltip" data-placement="top" title="'.$badge['name'].'" />
