...
<?php 
	if(isset($_POST['post7'])) {
		$system->deleteArticle($_POST['selectedid']);
	}
?>
...
<div class="alert alert-warning alert-dismissible" role="alert">
  ...
  <strong>Achtung!</strong> Achte auf die Groß- und Kleinschreibung. Wurde ein Artikel einmal aus dem Dark Visa Article System gelöscht so kann er nicht wiederhergestellt werden!
</div>
	<form method="post">
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-trash fa-fw"></i></span>
          <input type="text" name="selectedid" class="form-control" placeholder="Name des zu löschenden Artikels">
        </div>
		<br /><br />
		<input type="submit" value="Löschen" class="btn btn-success" />
		<input type="hidden" name="post7" />
	</form>
	<br />
