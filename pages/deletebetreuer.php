...
<?php 
	if(isset($_POST['post4'])) {
		$firefighters->deleteYouthLeader($_POST['selectedid2']);
	}
?>
<div class="page-header">
  <h1>Betreuer löschen</h1>
</div>
  ...
  <strong>Achtung!</strong> Achte auf die Groß- und Kleinschreibung.
	...
	<form method="post">
        <div class="input-group">
          ...
          <input type="text" name="selectedid2" class="form-control" placeholder="Name des zu löschenden Betreuers">
        </div>
		<br /><br />
		<input type="submit" value="Löschen" class="btn btn-success" />
		<input type="hidden" name="post4" />
	</form>
	<br />
